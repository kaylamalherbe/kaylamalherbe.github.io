...
The expected results from the Wikipedia table:

| Kp | Rise time | Overshoot | Settling time | Stead-state error | Stability |
| -- | --------- | --------- | ------------- | ----------------- | --------- |
| Increased | Decreased | Increased | Small change | Decrease | Degrade |

Results from Model A Variation of Kp

![Kp variation Model](/images/Plot1_model.png)
![Effects of Kp Variation](/images/Plot1_kp_variation.png)
![Effects of Kp Variation Zoomed](/images/Plot1_kp_variation_steadstate.png)

Observations from graphs:

| Kp | Rise time | Overshoot | Settling time | Stead-state error | Stability |
| -- | --------- | --------- | ------------- | ----------------- | --------- |
| Decreased to 1000 | Increased | Decreased | Slightly faster | No error | Improved |
| Increased to 2000 | Decreased | Increased | Slightly slower | No error | Degrade |


### Varying $K_d$ while $K_p=1500$ and $K_i=0$

The expected results from the Wikipedia table:

| Kp | Rise time | Overshoot | Settling time | Stead-state error | Stability |
| -- | --------- | --------- | ------------- | ----------------- | --------- |
| Increased | Minor Change | Decrease | Decrease | No effect in thoery | Improve if Kd small |

![Kd variation Model](/images/Plot2_model.png)
![Effects of Kd variation](/images/Plot2_kd_variation.png)
![Effects of Kd Variation Zoomed](/images/Plot2_kd_variation_zoomed.png)


Observations from graphs:

| Kd | Rise time | Overshoot | Settling time | Stead-state error | Stability |
| -- | --------- | --------- | ------------- | ----------------- | --------- |
| Decreased to 20 | Minor change | Increased | Significantly Increased | No error | Degrade |
| Increased to 100 | Minor Change | Decreased | Decreased | No error | Improved |



### Varying $K_i$ while $K_p=1500$ and $K_d=50$

The expected results from the Wikipedia table:

| Kp | Rise time | Overshoot | Settling time | Stead-state error | Stability |
| -- | --------- | --------- | ------------- | ----------------- | --------- |
| Increased | Decrease | Increase | Increase | Eliminate | Degrade |


![Ki variation Model](/images/Plot3_model.png)
![Effects of Ki variation](/images/Plot3_ki_variaiton.png)
![Effects of Ki Variation Zoomed](/images/Plot3_ki_variaiton_zoomed.png)


Observations from graphs:

| Ki | Rise time | Overshoot | Settling time | Stead-state error | Stability |
| -- | --------- | --------- | ------------- | ----------------- | --------- |
| Decreased to -1000 | Increased | Decrease | Decrease | doesn't converge | Unstable Ki can't be neg |
| Increased to 2000 | Minsor Change | Increase | Increase | Unaffected | Not improved Kd not small |

Therefore effects of increasing a parameter are independently verified.
